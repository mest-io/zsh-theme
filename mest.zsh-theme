local logo="%B%F{magenta}Μ%b%f"
local user="%B%F{240}($USERNAME)%f%b"
local dir="%B%F{255}%1~%f%b"
...
# modified from https://github.com/vercel/zsh-theme/blob/master/vercel.zsh-theme
...
PROMPT='$logo $user $dir $(git_prompt)'
